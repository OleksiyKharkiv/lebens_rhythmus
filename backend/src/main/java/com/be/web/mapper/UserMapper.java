...
public class UserMapper {
    ...
    public User toEntity(UserRegistrationDTO dto) {
        return User.builder()
                ...
                .acceptedTerms(dto.getAcceptedTerms())
    ...
    public UserLoginResponseDTO toLoginResponseDTO(User user, String token, Long expiresIn,
    ...
    public UserProfileDTO toProfileDTO(User user) {
        return UserProfileDTO.builder()
                ...
                .lastName(user.getLastName())
                .phone(user.getPhone())
                .birthDate(user.getBirthDate()) // Просто присваиваем LocalDate
                .role(user.getRole())
                ...
                .title(user.getTitle())
                .bio(user.getBio())
                .enabled(user.getEnabled()) // Добавил если есть в UserProfileDTO
                .emailVerified(user.getEmailVerified()) // Добавил если есть в UserProfileDTO
                .termsAcceptedAt(user.getTermsAcceptedAt())
                .privacyPolicyAcceptedAt(user.getPrivacyPolicyAcceptedAt())
    ...
    public UserBasicDTO toBasicDTO(User user) {
        return UserBasicDTO.builder()
                ...
                .lastName(user.getLastName())
                .role(user.getRole())
                .enabled(user.getEnabled()) // Добавил если есть в UserBasicDTO
                .build();
    }
